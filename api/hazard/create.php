...
if ($barangay_id <= 0 || $municipality_id <= 0 || $hazard_type_id <= 0 || !$event_date) {
...
try {
    $stmt = $pdo->prepare('INSERT INTO hazards (barangay_id, municipality_id, hazard_type_id, event_date, severity, houses_affected) VALUES (:barangay_id, :municipality_id, :hazard_type_id, :event_date, :severity, :houses_affected)');
    $stmt->execute([
