...
try {
    ...
    // For demo purposes, log the code instead of sending email
    // Check the PHP error log to see the reset code
    error_log("DEMO: Password reset code for {$email}: {$resetCode}");
