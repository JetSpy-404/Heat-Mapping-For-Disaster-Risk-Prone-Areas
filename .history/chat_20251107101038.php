...
<html lang="en" dir="ltr">
    <head>
        ...
        <!-- Added: table layout fixes to keep headers and cells aligned -->
		<style>
		.panel-table-wrapper { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
            ...
            <div class="main-content flex flex-col min-h-screen">
                ...
                <!-- start main content section -->
                    <div class="panel pt-5" x-data="chat">
                        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)] sm:min-h-0" :class="{'min-h-[999px]' : isShowChatMenu}">
                            <div class="panel absolute z-10 hidden w-full max-w-xs flex-none space-y-4 overflow-hidden p-4 xl:relative xl:block xl:h-full" :class="isShowChatMenu && '!block'">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="flex-none"><img :src="$store.user ? ($store.user.profile_picture || 'assets/images/logo10.png') : 'assets/images/logo10.png'" class="h-12 w-12 rounded-full object-cover"></div>
                                        <div class="mx-3">
                                            <p class="mb-1 font-semibold" x-text="$store.user ? ($store.user.first_name + ' ' + $store.user.last_name) : 'Loading...'"></p>
                                            <p class="text-xs text-white-dark" x-text="$store.user ? $store.user.role : 'User'"></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="relative">
                                    <input type="text" class="peer form-input ltr:pr-9 rtl:pl-9" placeholder="Searching..." x-model="searchUser" @keyup="searchUsers">
                                ...
                                <div class="!mt-0">
                                    <div class="chat-users perfect-scrollbar relative -mr-3.5 h-full min-h-[100px] space-y-0.5 pr-3.5 sm:h-[calc(100vh_-_357px)]">
                                        <template x-for="person in searchUsers">
                                            <button type="button" class="flex w-full items-center justify-between rounded-md p-2 hover:bg-gray-100 hover:text-primary dark:hover:bg-[#050b14] dark:hover:text-primary" :class="{'bg-gray-100 dark:bg-[#050b14] dark:text-primary text-primary': selectedUser.userId === person.userId}" @click="selectUser(person)">
                                                <div class="flex-1">
                                                    <div class="flex items-center">
                                                        <div class="relative flex-shrink-0">
                                                            <img :src="person.path" class="h-12 w-12 rounded-full object-cover">
                                                        ...
                                                        <div class="mx-3 ltr:text-left rtl:text-right">
                                                            ...
                                                            <p class="max-w-[185px] truncate text-xs text-white-dark" x-text="person.preview"></p>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="panel flex-1 p-0">
                                <template x-if="!isShowUserChat">
                                    <div class="relative flex h-full items-center justify-center p-4">
                                        <button type="button" class="absolute top-4 hover:text-primary ltr:left-4 rtl:right-4 xl:hidden" @click="isShowChatMenu = !isShowChatMenu">
                                        ...
                                        <div class="flex flex-col items-center justify-center py-8">
                                            ...
                                            <div class="mb-8 h-[calc(100vh_-_320px)] min-h-[120px] w-[280px] text-white dark:text-[#0e1726] md:w-[430px]">
                                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="h-full w-full" viewbox="0 0 891.29496 745.19434" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    ...
                                                    <path d="M493.76439,275.26947H184.68447a7.00465,7.00465,0,1,1,0-14.00929H493.76439a7.00465,7.00465,0,0,1,0,14.00929Z" transform="translate(-154.35252 -77.40283)" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></path>
                                                    <path d="M393.07263,245.49973H184.68447a7.00465,7.00465,0,1,1,0-14.00929H393.07263a7.00464,7.00464,0,0,1,0,14.00929Z" transform="translate(-154.35252 -77.40283)" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></path>
                                                    ...
                                                    <path d="M603.53027,706.11319a89.06853,89.06853,0,0,1-93.65039,1.49,54.12885,54.12885,0,0,1,9.40039-12.65,53.43288,53.43288,0,0,1,83.90967,10.56994C603.2998,705.71316,603.41992,705.91318,603.53027,706.11319Z" transform="translate(-154.35252 -77.40283)" fill="#6c63ff"></path>
                                                    <circle cx="398.44256" cy="536.68841" r="44.20157" fill="#2f2e41"></circle>
                                                    <circle cx="556.81859" cy="629.4886" r="32.89806" transform="translate(-416.96496 738.72884) rotate(-61.33685)" fill="#ffb8b8"></circle>
                                                    ...
                                                    <path d="M555.5,721.17319a89.97205,89.97205,0,1,1,48.5708-14.21875A89.87958,89.87958,0,0,1,555.5,721.17319Zm0-178a88.00832,88.00832,0,1,0,88,88A88.09957,88.09957,0,0,0,555.5,543.17319Z" transform="translate(-154.35252 -77.40283)" fill="#3f3d56"></path>
                                                    <circle cx="563.81601" cy="445.19345" r="13.13371" fill="#6c63ff"></circle>
                                                    <path d="M1020.76439,595.26947H711.68447a7.00465,7.00465,0,1,1,0-14.00929h309.07992a7.00464,7.00464,0,0,1,0,14.00929Z" transform="translate(-154.35252 -77.40283)" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></path>
                                                    <path d="M920.07263,565.49973H711.68447a7.00465,7.00465,0,1,1,0-14.00929H920.07263a7.00465,7.00465,0,0,1,0,14.00929Z" transform="translate(-154.35252 -77.40283)" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></path>
                                                    <ellipse cx="554.64354" cy="605.66091" rx="24.50394" ry="2.71961" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></ellipse>
                                                    <ellipse cx="335.64354" cy="285.66091" rx="24.50394" ry="2.71961" :fill="$store.app.theme === 'dark' || $store.app.isDarkMode ? '#888ea8' : '#e6e6e6'"></ellipse>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="relative h-full">
                                        <div class="flex items-center justify-between p-4">
                                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                <button type="button" class="hover:text-primary xl:hidden" @click="isShowChatMenu = !isShowChatMenu">
                                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6">
                                                        <path d="M20 7L4 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                        <path opacity="0.5" d="M20 12L4 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                        <path d="M20 17L4 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                ...
                                                <div class="relative flex-none">
                                                    <img :src="selectedUser.path" class="h-10 w-10 rounded-full object-cover sm:h-12 sm:w-12">
                                                    <div class="absolute bottom-0 ltr:right-0 rtl:left-0">
                                                        <div class="h-4 w-4 rounded-full bg-success"></div>
                                                    </div>
                                                </div>
                                                <div class="mx-3">
                                                    ...
                                                    <p class="text-xs text-white-dark" x-text="selectedUser.active ? 'Active now' : 'Last seen at '+selectedUser.time"></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                                            ...
                                            <div class="chat-conversation-box min-h-[400px] space-y-5 p-4 pb-[68px] sm:min-h-[300px] sm:pb-0">
                                                <div class="m-6 mt-0 block">
                                                    <h4 class="relative border-b border-[#f4f4f4] text-center text-xs dark:border-gray-800">
                                                        <span class="relative top-2 bg-white px-3 dark:bg-[#0e1726]" x-text="'Today, ' + selectedUser.time"></span>
                                                    </h4>
                                                </div>
                                                <template x-for="message in selectedUser.messages">
                                                    <div class="flex items-start gap-3" :class="{'justify-end' : selectedUser.userId === message.fromUserId}">
                                                        <div class="flex-none" :class="{'order-2' : selectedUser.userId === message.fromUserId}">
                                                            <template x-if="Alpine.store('user').id === message.fromUserId">
                                                                <img :src="Alpine.store('user').profile_picture || 'assets/images/logo.jpg'" class="h-10 w-10 rounded-full object-cover">
                                                            </template>
                                                            <template x-if="Alpine.store('user').id !== message.fromUserId">
                                                                <img :src="selectedUser.path" class="h-10 w-10 rounded-full object-cover">
                                                            </template>
                                                        </div>
                                                        <div class="space-y-2">
                                                            <div class="flex items-center gap-3">
                                                                <div class="rounded-md bg-black/10 p-4 py-2 dark:bg-gray-800" :class="message.fromUserId == selectedUser.userId ? 'ltr:rounded-br-none rtl:rounded-bl-none !bg-primary text-white' : 'ltr:rounded-bl-none rtl:rounded-br-none'" x-text="message.text"></div>
                                                                <div :class="{'hidden' : selectedUser.userId === message.fromUserId}">
                                                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hover:text-primary">
                                                                        <circle opacity="0.5" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.5"></circle>
                                                            ...
                                                            <div class="text-xs text-white-dark" :class="{'ltr:text-right rtl:text-left' : selectedUser.userId === message.fromUserId}" x-text="message.time ? message.time: '5h ago'"></div>
                                                        </div>
                                                    </div>
                                                </template>
                                            </div>
        ...
        <script>
            ...
            function handleWebSocketMessage(data) {
                if (data.type === 'message') {
                    // Add message to chat if it's from the current conversation
                    if (Alpine.store('chat') && Alpine.store('chat').selectedUser &&
                        Alpine.store('chat').selectedUser.userId == data.sender_id) {
                        Alpine.store('chat').messages.push({
                            fromUserId: data.sender_id,
                            toUserId: Alpine.store('user').id,
                            text: data.message,
                            time: new Date(data.timestamp).toLocaleTimeString(),
                            read: 0
                        });
                        Alpine.store('chat').scrollToBottom();
                    } else {
                        // Show notification for new message if not in current chat
                        showNotificationForNewMessage(data.sender_id, data.message);
                    }
                    // Refresh conversations to show new message
                    Alpine.store('chat').loadConversations();
                }
            }

            async function showNotificationForNewMessage(senderId, message) {
                try {
                    // Fetch sender details
                    const res = await fetch(`api/users/get.php?id=${senderId}`);
                    ...
                    if (userData.success) {
                        ...
                        showNotification(`New message from ${senderName}: ${messagePreview}`, 'success', () => {
                            // On click, open chat with this user
                            if (Alpine.store('chat')) {
                                const user = Alpine.store('chat').contactList.find(u => u.userId == senderId);
                                if (user) {
                                    Alpine.store('chat').selectUser(user);
                                }
                            }
                        });

                        // Show browser notification if permission granted
                        showBrowserNotification(senderName, messagePreview, senderId);
                    }
                } catch (err) {
                    ...
                    if (Notification.permission === 'granted') {
                        ...
                        Notification.requestPermission().then(permission => {
                            if (permission === 'granted') {
                                showBrowserNotification(title, body, senderId);
                            }
                        });
                    }
                }
            ...
            // Initialize WebSocket after user data is loaded
            async function init() {
                initEventListeners();
                await loadUserData();
                initWebSocket();
                ...
                Alpine.data('chat', () => ({
                    ...
                    async loadConversations() {
                        try {
                            ...
                            if (data.success) {
                                this.contactList = data.data.map(user => ({
                                    userId: user.id,
                                    name: `${user.first_name} ${user.last_name}`,
                                    path: user.profile_picture || 'assets/images/default-avatar.jpg',
                                    time: user.last_timestamp ? new Date(user.last_timestamp).toLocaleTimeString() : '',
                                    preview: user.last_message || 'No messages yet',
                                    active: true,
                    ...
                    async selectUser(user) {
                        ...
                        this.selectedUser.messages = []; // Initialize messages array
                    ...
                    async loadMessages(userId) {
                        try {
                            const res = await fetch(`api/messages/list.php?user_id=${userId}`);
                            const data = await res.json();
                            if (data.success) {
                                // Store messages in selectedUser, not in this.messages
                                this.selectedUser.messages = data.data.map(msg => ({
                    ...
                    sendMessage() {
                        if (this.textMessage.trim() && this.selectedUser && socket && socket.readyState === WebSocket.OPEN) {
                            // Send message via WebSocket
                            socket.send(JSON.stringify({
                                type: 'message',
                                receiver_id: this.selectedUser.userId,
                                message: this.textMessage.trim()
                            }));

                            // Add message to local chat immediately for better UX
                            this.selectedUser.messages.push({
                                fromUserId: Alpine.store('user').id,
    ...
    function initEventListeners() {
        ...
        // For example, keyboard shortcuts, window focus events, etc.

        // Handle window focus to refresh conversations
    ...
    function updateUserDropdown(user) {
        ...
        // Update the sidebar profile section
        const sidebarImg = document.querySelector('.sidebar .flex.items-center .flex-none img');
        if (sidebarImg) sidebarImg.src = user.profile_picture || 'assets/images/logo10.png';

        const sidebarName = document.querySelector('.sidebar .flex.items-center .mx-3 p.font-semibold');
        if (sidebarName) sidebarName.textContent = `${user.first_name} ${user.last_name}`;

        const sidebarRole = document.querySelector('.sidebar .flex.items-center .mx-3 p.text-xs');
