<?php include_once __DIR__ . '/session_check.php'; ?>
<?php include_once __DIR__ . '/access_control.php'; ?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                ...
                <nav x-data="sidebar" class="sidebar fixed top-0 bottom-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="dashboard.php" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="assets/images/logo10.png" alt="image">
                                <span id="sidebar-role" class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Administrator</span>
                            </a>
                        ...
                        <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: null }">
                            ...
                            <li class="nav-item">
                                <ul>
                                    <li class="nav-item">
                                        <a href="statistics.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Statistics</span>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                ...
                                <span>Maps</span>
                                    ...
                                    <li class="nav-item">
                                        <a href="heatmap.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Heatmap</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item" x-show="canAccessFeature('chloropleth')">
                                        <a href="chloropleth.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g opacity="0.5">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Chloropleth</span>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                ...
                                <span>Data</span>
                                    ...
                                    <li class="nav-item" x-show="canAccessFeature('hazard_types')">
                                        <a href="hazard_types.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Hazard Types</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="hazard_data.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Hazard Data</span>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                ...
                                <span>Locations</span>
                                    ...
                                    <li class="nav-item">
                                        <a href="barangay.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Barangay</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item" x-show="canAccessFeature('municipality')">
                                        <a href="municipality.php" class="group">
                                            <div class="flex items-center">
                                                <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path opacity="0.5" d="M10.75 7C10.75 6.30964 11.3096 5.75 12 5.75C12.6904 5.75 13.25 6.30964 13.25 7C13.25 7.69036 12.6904 8.25 12 8.25C11.3096 8.25 10.75 7.69036 10.75 7Z" fill="currentColor"/>
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Municipalities</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                            ...
                            <li class="menu nav-item" x-show="canAccessFeature('municipality_users')">
                                <a href="municipality_users.php" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Municipality Users</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="index.html" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="assets/images/logo10.png" alt="image">
                                    <span id="header-role" class="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">Administrator</span>
                                </a>
                            ...
                            <div x-data="header" class="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                                ...
                                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="assets/images/logo.jpg" alt="image"></span>
                                    </a>
                                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="assets/images/logo.jpg" alt="image">
                                                </div>
                                        ...
                                        <li>
                                            <a href="chat.php" class="dark:hover:text-white" @click="toggle">
                                                <svg class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" width="18" height="18" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div x-data="finance">
                        ...
                        <div class="pt-5">
                            <div class="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                                <!-- Temperature -->
                                <div id="temperature-card" class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Temperature</div>
                                        <i class="fas fa-temperature-high weather-icon"></i>
                                    </div>
                                    <div class="mt-5">
                                        <h6 class="mb-0"><span id="current-temp"></span> °C</h6>
                                        <small>Feels like: <span id="feels-like"></span>°C</small>
                                    </div>
                                </div>

                                <!-- Precipitation -->
                                <div id="precipitation-card" class="panel bg-gradient-to-r from-violet-500 to-violet-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Precipitation</div>
                                        <i class="fas fa-cloud-rain weather-icon"></i>
                                    </div>
                                    <div class="mt-5">
                                        <h6 class="mb-0"><span id="precipitation"></span> mm/hr</h6>
                                        <small>Last hour</small>
                                    </div>
                                </div>

                                <!-- Humidity -->
                                <div id="humidity-card" class="panel bg-gradient-to-r from-blue-500 to-blue-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Humidity</div>
                                        <i class="fas fa-tint weather-icon"></i>
                                    </div>
                                    <div class="mt-5">
                                        <h6 class="mb-0"><span id="humidity"></span> %</h6>
                                        <small>Dew point: <span id="dew-point"></span>°C</small>
                                    </div>
                                </div>

                                <!-- Wind -->
                                <div id="wind-card" class="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Wind</div>
                                        <i class="fas fa-wind weather-icon"></i>
                                    </div>
                                    <div class="mt-5">
                                        <div class="flex items-center">
                                            <span id="wind-direction"></span> 
                                            <span id="wind-speed" class="ml-1"></span> km/h
                                        </div>
                                        <small>Gusts: <span id="wind-gust"></span> km/h</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-5 overflow-x-hidden">
                            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                <div class="panel h-full w-full">
                                    <div class="alert alert-danger flex items-center mb-3 p-2">
                                        <i class="fa fa-exclamation-triangle me-3 text-xl"></i>
                                        <div>
                                            <h6 class="mb-0 font-semibold">AUTOMATED WARNING SYSTEM</h6>
                                            <small class="text-gray-300">Last updated: <span id="weather-update-time">Loading...</span></small>
                                        </div>
                                    </div>
                                    
                                    <div id="alert-level-banner" style="display: none;">
                                        <div class="flex justify-between items-center mb-2">
                                            <div>
                                                <span id="alert-type" class="font-bold"></span>
                                                <span id="alert-location"></span>
                                            </div>
                                            <span id="alert-level" class="badge"></span>
                                        </div>
                                        <p id="alert-message" class="mt-2 mb-0 text-sm"></p>
                                        
                                        <!-- Enhanced warning system -->
                                        <div id="rainfall-warning" class="mt-4">
                                            <h6 class="font-bold mb-2">24-HR RAINFALL FORECAST</h6>
                                            
                                            <!-- Rainfall threshold indicator -->
                                            <div class="threshold-indicator">
                                                <div class="threshold-label">24-Hour Total:</div>
                                                <div class="threshold-bar">
                                                    <div id="threshold-fill" class="threshold-fill intensity-low" style="width: 0%"></div>
                                                </div>
                                                <div class="threshold-value"><span id="rainfall-value">0</span> mm</div>
                                            </div>
                                            ...
                                            <!-- Warning levels -->
                                            <div id="warning-levels" class="mt-3">
                                                <div class="warning-level warning-moderate" style="display: none;" data-threshold="50">
                                                    <i class="fas fa-exclamation-triangle mr-2"></i>
                                                    MODERATE WARNING (50-100mm)
                                                </div>
                                                <div class="warning-level warning-high" style="display: none;" data-threshold="100">
                                                    <i class="fas fa-exclamation-circle mr-2"></i>
                                                    HIGH WARNING (100-200mm)
                                                </div>
                                                <div class="warning-level warning-critical pulse-alert" style="display: none;" data-threshold="200">
                                                    <i class="fas fa-radiation mr-2"></i>
                                                    CRITICAL WARNING (>200mm)
                                                </div>
                                            </div>
                                            
                                            <!-- Affected barangays -->
                                            <div id="affected-barangays" class="mt-3" style="display: none;">
                                                <h6 class="font-bold mb-2">AFFECTED BARANGAYS:</h6>
                                                <div class="barangay-list">
                                                    <div id="barangay-list-content"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel h-full w-full">
                                    <div class="weather-charts-container">
                                        <div class="chart-title">Weather Statistics</div>
                                        <div class="chart-nav">
                                            <button class="chart-nav-btn active" onclick="showChart('rainfall')">Rainfall</button>
                                            <button class="chart-nav-btn" onclick="showChart('temperature')">Temperature</button>
                                            <button class="chart-nav-btn" onclick="showChart('humidity')">Humidity</button>
                                            <button class="chart-nav-btn" onclick="showChart('wind')">Wind</button>
                                        </div>
                                        ...
                                        <div class="chart-legend" id="chart-legend">Last 24 hours</div>
                                    </div>
                                </div>
                                <div class="panel h-full w-full">
                                        <div class="flex items-center justify-between mb-4">
                                            <h6 class="mb-0 font-semibold">5-Day Weather Forecast</h6>
                                            <div class="custom-dropdown">
                                                <button class="custom-dropdown-toggle" type="button" id="locationDropdown">
                                                    <span id="current-location">Biliran, Biliran</span>
                                                    <i class="fas fa-chevron-down ml-2 text-sm"></i>
                                                </button>
                                                <div class="custom-dropdown-menu" id="locationDropdownMenu">
                                                    <button class="custom-dropdown-item" data-location="Naval,PH">Naval, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Almeria,PH">Almeria, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Kawayan,PH">Kawayan, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Biliran,PH">Biliran, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Culaba,PH">Culaba, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Cabucgayan,PH">Cabucgayan, Biliran</button>
                                                    <button class="custom-dropdown-item" data-location="Caibiran,PH">Caibiran, Biliran</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="weather-forecast-container" class="forecast-container-fixed">
                                ...
                                <div class="panel h-full w-full">
                                    <div style="min-height: 50vh; width: 100%;">
                                            <iframe src="https://embed.windy.com/embed2.html?lat=11.56056&lon=124.3975&zoom=5&level=surface&overlay=satellite"
                                                width="100%"
                                                frameborder="0"
                                                style="border:0; min-height: 600px; height: 100%;"
                                                allowfullscreen>
                                            </iframe>
                                    </div>
                                </div>
                        ...
                        <div class="panel h-full w-full">
                            <div style="min-height: 70vh; width: 100%;">
                                <iframe src="https://www.rainviewer.com/hurricane-map.html?loc=17.9042,117.8888,4.1090850674385635&layer=sat&hu=1&ts=2" width="100%" frameborder="0" style="border:0;height:70vh;" allowfullscreen></iframe>
                            </div>
                            <br>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #58e7fa;"></span>
                                        <span>Tropical Depression (38 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #5899fa;"></span>
                                        <span>Tropical Storm (39-73 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #fffe54;"></span>
                                        <span>Category 1 Hurricane (74-95 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #f8cd46;"></span>
                                        <span>Category 2 Hurricane (96-110 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #ee6f2d;"></span>
                                        <span>Category 3 Hurricane (111-129 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #ff0000;"></span>
                                        <span>Category 4 Hurricane (130-156 mph)</span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="inline-block w-4 h-4 rounded mr-2" style="background-color: #a4000f;"></span>
                                        <span>Category 5 Hurricane (157 mph or higher)</span>
                                    </div>
                                </div>
                        </div>
                        </div>
            ...
            <!-- Rain Alarm (hidden audio element) -->
            <audio id="rain-alarm" preload="auto">
                <source src="assets/alarm.wav" type="audio/mpeg">
            </audio>
        </div>
        </div>
...
<script>
// Weather Dashboard Configuration - Updated for Open Meteo API
const WEATHER_CONFIG = {
    API_KEY: null, // Open Meteo doesn't require API key
    BASE_URL: "https://api.open-meteo.com/v1",
    DEFAULT_LOCATION: "11.4667,124.4833", // Biliran, Biliran coordinates
    REFRESH_INTERVAL: 30 * 60 * 1000, // 30 minutes
    MAX_RETRIES: 3,
    RETRY_DELAY: 3000 // 3 seconds
};

// Location mapping for municipalities in Biliran
const LOCATION_COORDINATES = {
    "Naval,PH": { latitude: 11.5833, longitude: 124.4500 },
    "Almeria,PH": { latitude: 11.6203, longitude: 124.3817 },
    "Kawayan,PH": { latitude: 11.6894, longitude: 124.3592 },
    "Biliran,PH": { latitude: 11.4667, longitude: 124.4833 },
    "Culaba,PH": { latitude: 11.6575, longitude: 124.5425 },
    "Cabucgayan,PH": { latitude: 11.4711, longitude: 124.5747 },
    "Caibiran,PH": { latitude: 11.5717, longitude: 124.5822 }
};

// Rainfall thresholds for warnings
const RAINFALL_THRESHOLDS = {
    MODERATE: 50,    // 50mm - Localized flooding possible
    HIGH: 100,       // 100mm - Numerous flooding events likely
    CRITICAL: 200    // 200mm - Widespread severe flooding expected
};

// Sample data for barangays in different municipalities
const BARANGAYS_BY_MUNICIPALITY = {
    "Naval,PH": [
        "Agpangi", "Anislagan", "Atipolo", "Calumpang", "Capiñahan", 
        "Caraycaray", "Catmon", "Haguikhikan", "Padre Inocentes Garcia", 
        "Libertad", "Lico", "Lucsoon", "Mabini", "San Pablo", "Santissimo Rosario"
    ],
    "Almeria,PH": [
        "Igang", "Jamorawon", "Looc", "Marevil", "Matanggo", 
        "Pili", "Poblacion", "Pulang Bato", "Salangi", "Tinalian"
    ],
    "Kawayan,PH": [
        "Baganito", "Bulusan", "Bunga", "Caucab", "Kansanok", 
        "Mada-o", "Mapuyo", "Masagaosao", "Masagongsong", "Poblacion"
    ],
    "Biliran,PH": [
        "Bato", "Burabod", "Busali", "Hugpa", "Julita", 
        "Canila", "Pinangumhan", "San Isidro", "San Roque", "Villa Enage"
    ],
    "Culaba,PH": [
        "Acaban", "Bacolod", "Binongaan", "Bool Central", "Bool East", 
        "Bool West", "Calipayan", "Guindapunan", "Habuhab", "Looc"
    ],
    "Cabucgayan,PH": [
        "Balaquid", "Baso", "Bunga", "Caanibongan", "Casiawan", 
        "Esperanza", "Langgao", "Libertad", "Looc", "Maguilling"
    ],
    "Caibiran,PH": [
        "Alegria", "Asug", "Bari-is", "Binohangan", "Cabalquinto", 
        "Kawayanon", "Looc", "Manlabang", "Maurang", "Palanay"
    ]
};

// Global variables
let currentLocation = WEATHER_CONFIG.DEFAULT_LOCATION;
let weatherCharts = {};
let retryCount = 0;
let hourlyRainfallData = Array(24).fill(0); // Store rainfall for last 24 hours
let last24HourTotal = 0;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fallback check if DOM is already loaded
    if (document.readyState === 'complete') {
        initializeWeatherDashboard();
    } else {
        window.addEventListener('load', initializeWeatherDashboard);
    }
});
...
function initCustomDropdown() {
    const dropdownToggle = document.getElementById('locationDropdown');
...
function initWarningSystem() {
    ...
    updateRainfallIndicator(0);
}

/**
 * Initializes the weather dashboard with retry mechanism
 */
function initializeWeatherDashboard() {
    ...
    try {
        ...
        // Start data loading with retry mechanism
        retryCount = 0;
        attemptLoad();
        
        // Set up periodic refresh
        setInterval(fetchWeatherData, WEATHER_CONFIG.REFRESH_INTERVAL);
    } catch (error) {
        console.error("Dashboard initialization failed:", error);
        showErrorState("Dashboard initialization failed. Please refresh the page.");
    }
}

/**
 * Attempts to load weather data with retries
 */
function attemptLoad() {
    fetchWeatherData().then(success => {
        if (!success && retryCount < WEATHER_CONFIG.MAX_RETRIES) {
            retryCount++;
            console.log(`Retrying in ${WEATHER_CONFIG.RETRY_DELAY/1000} seconds... (Attempt ${retryCount})`);
            setTimeout(attemptLoad, WEATHER_CONFIG.RETRY_DELAY * retryCount);
        }
    });
}

// ----------------------
// WEATHER DATA FUNCTIONS (updated for Open Meteo API)
// ----------------------
...
async function fetchWeatherData() {
    ...
    try {
        ...
        if (currentLocation.includes(',')) {
            [lat, lon] = currentLocation.split(',').map(coord => parseFloat(coord.trim()));
        } else {
            // Handle municipality names
            const coords = LOCATION_COORDINATES[currentLocation];
            if (!coords) {
        ...
        const apiUrl = `${WEATHER_CONFIG.BASE_URL}/forecast?latitude=${lat}&longitude=${lon}&current=temperature_2m,relative_humidity_2m,precipitation,rain,wind_speed_10m,wind_direction_10m&hourly=temperature_2m,relative_humidity_2m,precipitation,rain,wind_speed_10m&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,rain_sum&timezone=auto&forecast_days=5`;
...
/**
 * Shows loading state with timeout warning
 */
    ...
    if (forecastContainer) {
        forecastContainer.innerHTML = `
            <div class="text-center py-5">
                ...
                <p class="mt-2">Loading weather data...</p>
                <small class="text-gray-500">This may take a moment</small>
...
/**
 * Processes weather data from Open Meteo API
 */
function processWeatherData(data) {
    ...
    updateCurrentWeather(data.current, data.timezone);
    ...
    calculate24HourRainfall(data);
    
    // Update rainfall warning system
    updateRainfallWarningSystem();
}

/**
 * Calculates the total rainfall over the last 24 hours
 */
function calculate24HourRainfall(data) {
    // Reset the total
    last24HourTotal = 0;
    
    // Check if we have hourly precipitation data
    if (data.hourly && data.hourly.precipitation) {
        const now = new Date();
        const currentHour = now.getHours();
        
        // Get precipitation for last 24 hours
        const hourlyPrecip = data.hourly.precipitation;
        const hourlyTime = data.hourly.time;
        
        // Find the index for current hour and sum last 24 hours
        for (let i = 0; i < hourlyTime.length; i++) {
            const hourTime = new Date(hourlyTime[i]);
            const hoursDiff = (now - hourTime) / (1000 * 60 * 60);
            
            if (hoursDiff >= 0 && hoursDiff <= 24) {
                last24HourTotal += hourlyPrecip[i] || 0;
            }
        }
    }
    
    // If no hourly data, use daily precipitation
    if (last24HourTotal === 0 && data.daily && data.daily.precipitation_sum) {
        last24HourTotal = data.daily.precipitation_sum[0] || 0;
    }
    
    console.log("24-hour rainfall total:", last24HourTotal);
}

/**
 * Updates the rainfall warning system based on current data
 */
function updateRainfallWarningSystem() {
    updateRainfallIndicator(last24HourTotal);
    
    // Show appropriate warning level
    document.querySelectorAll('.warning-level').forEach(warning => {
        warning.style.display = 'none';
    });
    
    // Get current location name for warnings
    const locationName = getCurrentLocationName();
    
    if (last24HourTotal >= RAINFALL_THRESHOLDS.CRITICAL) {
        const criticalWarning = document.querySelector('.warning-critical');
        criticalWarning.style.display = 'flex';
        // Update warning text with location
        const warningText = criticalWarning.querySelector('.warning-text');
        if (warningText) {
            warningText.textContent = `CRITICAL FLOODING ALERT for ${locationName}: Extreme rainfall detected. Immediate evacuation recommended for flood-prone areas.`;
        }
        showAffectedBarangays(true);
    } else if (last24HourTotal >= RAINFALL_THRESHOLDS.HIGH) {
        const highWarning = document.querySelector('.warning-high');
        highWarning.style.display = 'flex';
        // Update warning text with location
        const warningText = highWarning.querySelector('.warning-text');
        if (warningText) {
            warningText.textContent = `FLOOD WARNING for ${locationName}: Heavy rainfall expected. Prepare for possible flooding in low-lying areas.`;
        }
        showAffectedBarangays(true);
    } else if (last24HourTotal >= RAINFALL_THRESHOLDS.MODERATE) {
        const moderateWarning = document.querySelector('.warning-moderate');
        moderateWarning.style.display = 'flex';
        // Update warning text with location
        const warningText = moderateWarning.querySelector('.warning-text');
        if (warningText) {
            warningText.textContent = `FLOOD ADVISORY for ${locationName}: Moderate rainfall expected. Stay alert in flood-prone areas.`;
        }
        showAffectedBarangays(true);
    } else {
        showAffectedBarangays(false);
    }
    
    // Always show the alert banner if there's any rainfall
    const alertBanner = document.getElementById('alert-level-banner');
    if (last24HourTotal > 0) {
        alertBanner.style.display = 'block';
        
        // Update alert message based on rainfall level with location
        let alertType, alertLevel, alertMessage;
        
        if (last24HourTotal >= RAINFALL_THRESHOLDS.CRITICAL) {
            alertType = `CRITICAL RAINFALL WARNING - ${locationName}`;
            alertLevel = 'Critical';
            alertMessage = `Extreme rainfall (${last24HourTotal.toFixed(1)}mm in 24 hours) in ${locationName}. Widespread incidents of severe flooding and landslides expected.`;
        } else if (last24HourTotal >= RAINFALL_THRESHOLDS.HIGH) {
            alertType = `HIGH RAINFALL WARNING - ${locationName}`;
            alertLevel = 'High';
            alertMessage = `Heavy rainfall (${last24HourTotal.toFixed(1)}mm in 24 hours) in ${locationName}. Numerous flooding events are likely, especially in areas that are urbanized, low lying, or near rivers.`;
        } else if (last24HourTotal >= RAINFALL_THRESHOLDS.MODERATE) {
            alertType = `MODERATE RAINFALL ADVISORY - ${locationName}`;
            alertLevel = 'Moderate';
            alertMessage = `Moderate rainfall (${last24HourTotal.toFixed(1)}mm in 24 hours) in ${locationName}. Localized flooding is possible mainly in areas that are urbanized, low lying, or near rivers.`;
        } else {
            alertType = `LIGHT RAINFALL NOTICE - ${locationName}`;
            alertLevel = 'Light';
            alertMessage = `Light rainfall (${last24HourTotal.toFixed(1)}mm in 24 hours) in ${locationName}. No significant impacts expected.`;
        }
        
        setElementText('alert-type', alertType);
        setElementText('alert-level', alertLevel);
        setElementText('alert-message', alertMessage);
        
        // Set alert level color
        const alertLevelElement = document.getElementById('alert-level');
        alertLevelElement.className = 'badge ' + (
            last24HourTotal >= RAINFALL_THRESHOLDS.CRITICAL ? 'bg-danger' :
            last24HourTotal >= RAINFALL_THRESHOLDS.HIGH ? 'bg-warning' :
            last24HourTotal >= RAINFALL_THRESHOLDS.MODERATE ? 'bg-info' : 'bg-primary'
        );
        
        alertBanner.className = `alert ${last24HourTotal >= RAINFALL_THRESHOLDS.CRITICAL ? 'bg-danger' :
                                last24HourTotal >= RAINFALL_THRESHOLDS.HIGH ? 'bg-warning' :
                                last24HourTotal >= RAINFALL_THRESHOLDS.MODERATE ? 'bg-info' : 'bg-primary'} text-white`;
    } else {
...
/**
 * Gets the current location name for display in warnings
 */
function getCurrentLocationName() {
    // Extract location name from currentLocation
    let locationName = "Naval"; // Default
    
    if (currentLocation.includes(',')) {
        // Handle coordinate format
        const municipality = Object.keys(LOCATION_COORDINATES).find(key => {
            const coords = LOCATION_COORDINATES[key];
            return `${coords.latitude},${coords.longitude}` === currentLocation;
        });
        
        if (municipality) {
            locationName = municipality.split(',')[0]; // Remove ",PH" suffix
        }
    } else {
        // Handle municipality name format
        locationName = currentLocation.split(',')[0]; // Remove ",PH" suffix if present
    }
...
/**
 * Updates the rainfall indicator
 */
function updateRainfallIndicator(rainfall) {
    const thresholdFill = document.getElementById('threshold-fill');
    const rainfallValue = document.getElementById('rainfall-value');
    
    rainfallValue.textContent = rainfall.toFixed(1);
    
    // Calculate percentage (capped at 250mm for visualization)
    const percentage = Math.min((rainfall / 250) * 100, 100);
    thresholdFill.style.width = `${percentage}%`;
    
    // Update color based on intensity
    thresholdFill.className = 'threshold-fill ' + (
        rainfall >= RAINFALL_THRESHOLDS.CRITICAL ? 'intensity-extreme' :
        rainfall >= RAINFALL_THRESHOLDS.HIGH ? 'intensity-high' :
        rainfall >= RAINFALL_THRESHOLDS.MODERATE ? 'intensity-moderate' : 'intensity-low'
    );
}

/**
 * Shows affected barangays based on rainfall level
 */
function showAffectedBarangays(show) {
    const affectedBarangays = document.getElementById('affected-barangays');
    
    if (show && last24HourTotal >= RAINFALL_THRESHOLDS.MODERATE) {
        affectedBarangays.style.display = 'block';
        
        // Get barangays for current municipality
        const municipality = Object.keys(LOCATION_COORDINATES).find(key => 
            LOCATION_COORDINATES[key].latitude + ',' + LOCATION_COORDINATES[key].longitude === currentLocation
        ) || currentLocation;
        
        const barangays = BARANGAYS_BY_MUNICIPALITY[municipality] || [];
        
        // Update the location in the barangay section header
        const locationName = getCurrentLocationName();
        const barangayHeader = document.querySelector('#affected-barangays .card-header');
        if (barangayHeader) {
            barangayHeader.textContent = `Potentially Affected Barangays in ${locationName}`;
        }
        
        // Determine how many barangays to show based on rainfall intensity
        let barangayCount = 0;
        if (last24HourTotal >= RAINFALL_THRESHOLDS.CRITICAL) {
            barangayCount = Math.min(barangays.length, 10); // Show all or up to 10
        } else if (last24HourTotal >= RAINFALL_THRESHOLDS.HIGH) {
            barangayCount = Math.min(barangays.length, 6); // Show up to 6
        } else {
            barangayCount = Math.min(barangays.length, 3); // Show up to 3
        }
        
        // Display the barangays
        const barangayListContent = document.getElementById('barangay-list-content');
        barangayListContent.innerHTML = '';
        
        for (let i = 0; i < barangayCount; i++) {
            const barangayItem = document.createElement('div');
            barangayItem.className = 'barangay-item';
            barangayItem.textContent = barangays[i];
            barangayListContent.appendChild(barangayItem);
        }
        
        // Show note about location-specific warnings
        const barangayNote = document.getElementById('barangay-note');
        if (barangayNote) {
            barangayNote.textContent = `Based on current rainfall data for ${locationName}. Flood risk may vary by elevation and proximity to water bodies.`;
        }
    } else {
        affectedBarangays.style.display = 'none';
    }
}

/**
 * Handles weather data errors with user feedback
 */
function handleWeatherError(error) {
    ...
    setElementText('precipitation', '0.0');
    setElementText('current-temp', '--');
    setElementText('humidity', '--');
    setElementText('wind-speed', '--');
}

/**
 * Shows error state with retry button
 */
function showErrorState(message = "Failed to load weather data") {
            ...
            <div class="alert alert-danger">
                ...
                <div class="mt-2">
                    <button onclick="retryLoading()">
                        <i type"button" class="btn btn-warning btn-sm fa fa-sync-alt"> Retry</i>
                    </button>
                </div>
            </div>
        `;
...
/**
 * Retry loading function exposed to UI
 */
...
// ----------------------
// WEATHER DISPLAY FUNCTIONS (updated for Open Meteo data structure)
// ----------------------

/**
 * Updates current weather display with Open Meteo data
 */
function updateCurrentWeather(data, timezone) {
    if (!data) {
...
/**
 * Updates the weather update timestamp
 */
function updateTimestamp() {
    const now = new Date();
    const timestampElement = document.getElementById('weather-update-time');
    if (timestampElement) {
...
/**
 * Updates all weather cards with current data from Open Meteo
 */
function updateWeatherCards(data) {
    // Temperature
    setElementText('current-temp', Math.round(data.temperature_2m));
    setElementText('feels-like', Math.round(data.temperature_2m)); // Open Meteo doesn't provide feels like
    
    // Humidity
    setElementText('humidity', Math.round(data.relative_humidity_2m));
    setElementText('dew-point', Math.round(data.temperature_2m - (100 - data.relative_humidity_2m)/5));
    
    // Precipitation
    setElementText('precipitation', (data.precipitation || 0).toFixed(1));
...
/**
 * Updates wind display with direction and speed from Open Meteo
 */
function updateWindDisplay(data) {
    const windDirection = getWindDirection(parseInt(data.wind_direction_10m));
    ...
    if (windDirectionElement) {
        ...
        windArrow.className = 'fas fa-arrow-up wind-direction';
        windArrow.style.transform = `rotate(${data.wind_direction_10m}deg)`;
        windDirectionElement.prepend(windArrow);
    }
    
    setElementText('wind-speed', Math.round(data.wind_speed_10m));
    setElementText('wind-gust', Math.round(data.wind_speed_10m * 1.2)); // Estimate gust as 20% higher
}

/**
 * Updates 5-day forecast display with Open Meteo data
 */
function updateForecast(data) {
    ...
    if (!data || !data.daily || data.daily.time.length === 0) {
        forecastContainer.innerHTML = `
            <div class="alert alert-warning">
                No forecast data available. Please try again later.
            </div>
        `;
        return;
    }

    let forecastHTML = '<div class="grid grid-cols-5 gap-4">';
    ...
    for (let i = 0; i < 5; i++) {
        ...
        forecastHTML += `
            <div class="forecast-item bg-gray-800 rounded p-3 text-center">
                <div class="forecast-day">${dayName}</div>
                <i class="fas ${getWeatherIconFromPrecipitation(precipitation)} fa-2x my-2 ${getWeatherIconColorFromPrecipitation(precipitation)}"></i>
                <div class="mt-2">
                    <span class="font-bold">${maxTemp}°</span> / <span>${minTemp}°</span>
                </div>
                <small>${precipitation > 0 ? precipitation.toFixed(1) + 'mm rain' : 'Dry'}</small>
            </div>
        `;
    }
...
// ----------------------
// CHART FUNCTIONS (updated for Open Meteo data)
// ----------------------

/**
 * Initializes all weather charts with validation
 */
function initCharts() {
    ...
    try {
        ...
        const requiredCharts = ['rainfallChart', 'temperatureChart', 'humidityChart', 'windChart'];
        const missingCharts = requiredCharts.filter(id => !document.getElementById(id));
        
        if (missingCharts.length > 0) {
            throw new Error(`Missing chart containers: ${missingCharts.join(', ')}`);
        }
        
        // Rainfall Chart
        weatherCharts.rainfall = createChart('rainfallChart', {
            type: 'bar',
            data: {
                labels: [],
                datasets: [{
                    label: 'Rainfall (mm)',
                    data: [],
                    backgroundColor: '#F1C900FF',
                    borderColor: '#000304FF',
                    borderWidth: 1,
                    borderRadius: 4
                }]
            },
        ...
        // Temperature Chart
        weatherCharts.temperature = createChart('temperatureChart', {
            type: 'line',
            data: {
                labels: [],
                datasets: [{
        ...
        // Humidity Chart
        weatherCharts.humidity = createChart('humidityChart', {
            type: 'line',
            data: {
                labels: [],
                datasets: [{
        ...
        // Wind Chart
        weatherCharts.wind = createChart('windChart', {
            type: 'line',
            data: {
                labels: [],
                datasets: [{
        ...
        // Show rainfall chart by default
        showChart('rainfall');
        
        return true;
    } catch (error) {
        console.error("Chart initialization failed:", error);
        showErrorState("Failed to initialize charts. Please refresh the page.");
        return false;
    }
}
...
function createChart(elementId, config) {
    ...
    if (!ctx) {
        console.error(`Chart canvas not found: ${elementId}`);
        return null;
    }
...
/**
 * Updates all charts with Open Meteo weather data
 */
function updateCharts(data) {
    if (!data || !data.hourly || data.hourly.time.length === 0) {
        console.error('Invalid hourly data received');
        return;
    }

    const hourlyData = data.hourly;
    const timeLabels = hourlyData.time.slice(0, 24).map(time => {
        const date = new Date(time);
        return date.getHours() + ':00';
    }).reverse();
    
    // Update rainfall chart
    updateChartData('rainfall', timeLabels, hourlyData.precipitation.slice(0, 24).reverse());
    
    // Update temperature chart
    updateChartData('temperature', timeLabels, hourlyData.temperature_2m.slice(0, 24).map(temp => Math.round(temp)).reverse());
    
    // Update humidity chart
    updateChartData('humidity', timeLabels, hourlyData.relative_humidity_2m.slice(0, 24).map(hum => Math.round(hum)).reverse());
    
    // Update wind chart
    updateChartData('wind', timeLabels, hourlyData.wind_speed_10m.slice(0, 24).map(speed => Math.round(speed)).reverse());
}

/**
 * Updates specific chart data
 */
function updateChartData(chartName, labels, data) {
    if (weatherCharts[chartName]) {
        weatherCharts[chartName].data.labels = labels;
        weatherCharts[chartName].data.datasets[0].data = data;
        weatherCharts[chartName].update();
    }
}

/**
 * Shows specific chart and hides others
 */
function showChart(chartName) {
    ...
    // Update legend
    const legendText = {
        'rainfall': 'Rainfall in last 24 hours (mm)',
        'temperature': 'Temperature variation in last 24 hours (°C)',
        'humidity': 'Humidity variation in last 24 hours (%)',
        'wind': 'Wind speed in last 24 hours (km/h)'
    };
    
    setElementText('chart-legend', legendText[chartName] || 'Weather data');
}

// ----------------------
// UTILITY FUNCTIONS (updated for Open Meteo)
// ----------------------
...
/**
 * Gets weather icon based on precipitation (simplified for Open Meteo)
 */
function getWeatherIconFromPrecipitation(precipitation) {
    if (precipitation > 10) return 'fa-cloud-showers-heavy';
    if (precipitation > 5) return 'fa-cloud-rain';
    if (precipitation > 0) return 'fa-cloud-sun';
    return 'fa-sun';
}

/**
 * Gets weather icon color based on precipitation
 */
function getWeatherIconColorFromPrecipitation(precipitation) {
    if (precipitation > 10) return 'weather-rainy';
    if (precipitation > 5) return 'weather-rainy';
    if (precipitation > 0) return 'weather-cloudy';
    return 'weather-sunny';
}

/**
 * Gets precipitation value from weather data
 */
...
/**
 * Changes location and fetches new weather data
 */
function changeLocation(location) {
    // Handle both coordinate strings and municipality names
...
/**
 * Updates the displayed location name
 */
function updateLocationDisplay(location) {
    const locationElement = document.getElementById('current-location');
    if (locationElement) {
        // Extract municipality name from location string
        let locationName = location;
        if (location.includes(',')) {
            locationName = location.split(',')[0];
        }
        locationElement.textContent = `${locationName}, Biliran`;
    }
}
