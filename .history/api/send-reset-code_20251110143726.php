...
try {
    ...
    if (file_exists($phpmailerPath)) {
        ...
        try {
            // Server settings with your Mailtrap credentials
            $mail->isSMTP();
            $mail->Host = 'live.smtp.mailtrap.io';
            $mail->SMTPAuth = true;
            $mail->Username = 'apismtp@mailtrap.io'; // Your Mailtrap username
            $mail->Password = 'fee11b89c15767cdae592c19e3916684'; // Your Mailtrap password
            $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS; // STARTTLS
            $mail->Port = 587; // Using port 587 with STARTTLS

            // Alternatively, you can try port 2525 if 587 doesn't work:
            // $mail->Port = 2525;
