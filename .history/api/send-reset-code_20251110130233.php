...
try {
    ...
    // Uncomment and configure the email sending code below for production
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'Thesisheatmapping01@gmail.com'; // Replace with your email
        $mail->Password = 'THESISHEATMAPPING2025'; // Replace with app password
