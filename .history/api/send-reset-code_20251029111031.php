...
try {
    ...
    try {
        // For demo purposes, we'll use a simple mail() function instead of SMTP
        ...
        // Use PHP's built-in mail function for demo
        ...
        // Uncomment below for SMTP configuration when ready:
        /*
        $mail->isSMTP();
        ...
        */
        ...
        error_log('[send-reset-code] Mail error: ' . $e->getMessage());
        http_response_code(500);
        echo json_encode(['success' => false, 'message' => 'Failed to send email']);
    }
