...
<html lang="en" dir="ltr">
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div x-data="resetPassword">
                <div class="absolute inset-0">
                    <img src="assets/images/OOP.webp" alt="image" class="h-full w-full object-cover">
                </div>
                        ...
                        <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="index.html" class="w-48 block lg:w-72 ms-10">
                                    <img src="assets/images/logo10.png" alt="Logo" class="w-full">
                                </a>
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                ...
                                <div x-show="step === 1" x-transition>
                                    <form class="space-y-5" @submit.prevent="sendResetCode">
                                        <div>
                                            <label for="Email">Email</label>
                                            <div class="relative text-white-dark">
                                                <input id="Email" type="email" placeholder="Enter Email" class="form-input pl-10 placeholder:text-white-dark" x-model="email" required>
                                        ...
                                        <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]" :disabled="loading" x-text="loading ? 'SENDING...' : 'SEND CODE'">
                                            SEND CODE
                                        </button>
                                    </form>
                                </div>
                                ...
                                <div x-show="step === 2" x-transition>
                                    <h2 class="mb-3 text-xl font-bold !leading-snug dark:text-white">Check Your Email</h2>
                                    <p class="mb-7">We sent a code to <strong x-text="email"></strong>. Enter it below along with your new password.</p>
                                    <form class="space-y-5" @submit.prevent="resetPassword">
                                        <div>
                                            <label for="code">Verification Code</label>
                                            <input id="code" type="text" placeholder="Enter 6-digit code" class="form-input" x-model="code" required maxlength="6">
                                        </div>
                                        <div>
                                            <label for="newPassword">New Password</label>
                                            <input id="newPassword" type="password" placeholder="Enter new password" class="form-input" x-model="newPassword" required minlength="6">
                                        </div>
                                        <div>
                                            <label for="confirmPassword">Confirm New Password</label>
                                            <input id="confirmPassword" type="password" placeholder="Confirm new password" class="form-input" x-model="confirmPassword" required minlength="6">
                                        </div>
                                        <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]" :disabled="loading" x-text="loading ? 'RESETTING...' : 'RESET PASSWORD'">
                                            RESET PASSWORD
                                        </button>
                                        <button type="button" class="btn btn-outline-primary w-full !mt-3" @click="step = 1; resetForm()">BACK</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    sendResetCode() {
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                this.showAlert(data.message || 'Failed to send reset code', 'error');
                            }
                        })
                        .catch(error => {
                            this.loading = false;
