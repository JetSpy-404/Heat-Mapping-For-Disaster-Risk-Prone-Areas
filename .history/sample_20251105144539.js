...
// Remove default attribution if it exists and create custom one
...
// Your tile layers remain the same...
...
const streetMap = L.tileLayer('https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://hot.openstreetmap.org">Humanitarian OpenStreetMap</a>'
});
