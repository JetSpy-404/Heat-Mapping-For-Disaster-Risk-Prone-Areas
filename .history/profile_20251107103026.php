...
<html lang="en" dir="ltr">
    ...
    <body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
                                        ...
                                        <form class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
                                            ...
                                            <div class="flex flex-col sm:flex-row">
                                                <div class="mb-5 w-full sm:w-2/12 ltr:sm:mr-4 rtl:sm:ml-4">
                                                    <img id="profileImg" src="assets/images/profile-34.jpeg" alt="image" class="mx-auto h-20 w-20 rounded-full object-cover md:h-32 md:w-32">
                                                    <input id="profilePicture" type="file" accept="image/*" class="form-input mt-2 text-sm">
                                                </div>
                                                <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                                    <div>
                                                        <label for="fname">First Name</label>
                                                        <input id="fname" type="text" class="form-input" required>
                                                    </div>
                                                    <div>
                                                        <label for="lname">Last Name</label>
                                                        <input id="lname" type="text" class="form-input" required>
                                                    </div>
                                                    <div>
                                                        <label for="municipality">Municipality</label>
                                                        <select id="municipality" class="form-select text-white-dark">
                                                            <option value="">Select Municipality</option>
                                                        </select>
                                                    </div>
                                                    <div>
                                                        <label for="usertype">User Type</label>
                                                        <select id="usertype" class="form-select text-white-dark" disabled>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input id="contact" type="text" class="form-input" pattern="[0-9+\-() ]{3,32}">
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mt-3 flex justify-end">
                                                            <button type="button" id="saveBtn" class="btn btn-primary px-6 py-3 text-lg">Save</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input id="currentPassword" type="password" class="form-input pr-10" required>

                                                        <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center" onclick="togglePassword('currentPassword')">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input id="newPassword" type="password" class="form-input pr-10" required>

                                                        <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center" onclick="togglePassword('newPassword')">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <input id="confirmPassword" type="password" class="form-input pr-10" required>
                                                ...
                                                <div class="sm:col-span-2 flex justify-end">
                                                    ...
                                                    <button type="button" id="changePasswordBtn" class="btn btn-primary px-6 py-3 text-lg">Change Password</button>
        ...
        <script>
            ...
            // Load municipalities into the dropdown
            async function loadMunicipalities() {
                try {
                    const res = await fetch('api/municipality/list.php');
            ...
            // Load user data and update the dropdown and form
        ...
        if (data.success) {
            ...
            function populateForm(user) {
                ...
                document.getElementById('usertype').value = user.role || 'user';
                document.getElementById('municipality').value = user.municipality || '';
                document.getElementById('profileImg').src = user.profile_picture || 'assets/images/logo.jpg';
            }
            ...
            async function saveProfile() {
                ...
                formData.append('id', Alpine.store('user').id);
                ...
                formData.append('contact_number', document.getElementById('contact').value.trim());
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        // Update Alpine store and UI
                        Alpine.store('user', { ...Alpine.store('user'), ...data.data });
                        updateUserDropdown(Alpine.store('user'));
                        // Clear file input
                        fileInput.value = '';
                    } else {
            ...
            async function changePassword() {
                ...
                try {
                    ...
                    const res = await fetch('api/users/change_password.php', {
